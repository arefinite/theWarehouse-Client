            ...
            if(price > 0){
                if(!isNaN(stock)){
                    if(stock > 0 ){
                        ...
                        axiosPrivate.post('https://warehouse-api-server.herokuapp.com/stock', {allPdInfo, userInfo})
                        setErrorStock('')
                        setErrorPrice('')
                        ...
                        <form onSubmit={handleAddProduct}>
                            <div className="shadow overflow-hidden sm:rounded-md">
                                ...
                                <div className="px-4 py-3  lg:mr-64 sm:px-6">
                                    <button
                                        type="submit"
                                        className="inline-flex justify-center py-2 px-4 border border-transparent shadow-sm text-sm font-medium rounded-md text-white duration-300 bg-red-600 hover:bg-red-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500"
                                    >
                                        Add Product
                                    </button>
