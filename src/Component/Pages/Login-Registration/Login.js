        ...
        <>
            ...
            <div className="mt-10 sm:mt-0">
                <div className="flex justify-center">
                    ...
                    <h3 className="text-2xl font-medium leading-6 text-gray-900">Login</h3>
                        <form onSubmit={handleLogin}>
                            <div className="shadow overflow-hidden sm:rounded-md">
                                ...
                                <div onClick={handelRestPass} className="text-red-400 ml-4 md:ml-6 font-medium cursor-pointer" >Forget Password</div>
                                ...
                                <div className="px-4 py-3  lg:mr-64 sm:px-6">
                                    <button
                                        type="submit"
                                        className="inline-flex justify-center py-2 px-4 border border-transparent shadow-sm text-sm font-medium rounded-md text-white duration-300 bg-red-600 hover:bg-red-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-red-500"
                                    >
                                        Sign Up
                                    </button>
